...
import {
    ...
    Output, EventEmitter, ViewChild, ElementRef, Renderer2, OnDestroy, ChangeDetectionStrategy, HostBinding, Injectable
} from '@angular/core';
    ...
    animations: [
        ...
        trigger('menuState', [
            transition(':enter', [
                ...
                animate('0ms cubic-bezier(0, 0, 0, 0)', style({ transform: 'scale(0)' })),
...
export class MenuContainerComponent implements OnInit, OnDestroy {
    ...
    @ViewChild('menuWings', { static: true }) public menuWingsElm: ElementRef;
